# NaverApi 클래스 - OpenAPI : 인터넷 통해서 데이터 전달 받음
from urllib.request import Request, urlopen
from urllib.parse import quote
import datetime     # 현재시간 사용
import json     # 결과는 json으로 return 받음
...
class NaverApi:
    ...
    def get_request_url(self, url):
        req = Request(url)
        # Naver API 개인별 인증
        req.add_header('X-Naver-Client-Id', 'LJmqxVM0WYqGv1oUk6Ns')
        req.add_header('X-Naver-Client-Secret','zwlfZMq64O')
