...
class qtApp(QWidget):
    ...
    def __init__(self):
        ...
        self.btnRefresh.clicked.connect(self.initInfo)
    ...
    def initInfo(self):
        ...
        self.lblCPU1.setText(f'{cpu_ghz:.2f} GHz')
        ...
        sent = round(net_stat.bytes_sent / 1024 **2)
        recv = round(net_stat.bytes_recv / 1024 **2)
